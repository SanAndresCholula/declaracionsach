        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-8">
                            <h1 class="text-white">Agregar beneficiario a la base de datos</h1>
                        </div>
                        <div class="col-sm-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 col-sm-12">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" id="a_paterno" name="a_paterno" class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();" placeholder="** Apellido paterno" required title="Max. 30 caracteres" <?php if ($fila[15]  == 0) echo 'disabled readonly';
                                                                                                                                                                                                                                                                        else echo ''; ?>>
                                                            </div>
                                                        </div>
                                                    <?php endforeach ?>
                                                    ...
                                                    <div class="card-footer">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-sm-12">
                                                                ...
                                                                ?>
                                                                <a href="generarcode.php?id=<?php echo $id['id_benef']; ?>" class="btn btn-md btn-primary " id="<?php if ($fila[15]  == 0) echo 'bloquear';
                                                                                                                                                                else echo ''; ?>"><i class='fas fa-barcode'></i> Generar código</a>

                                                                <a href="card.php?id=<?php echo $id['id_benef']; ?>" class="btn btn-md btn-warning" id="<?php if ($fila[15]  == 0) echo 'bloquear';
                                                                                                                                                        else echo ''; ?>"><i class='fas fa-id-card '></i> Ir a card</a>
