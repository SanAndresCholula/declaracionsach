        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-white">CRUD Secretarías</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                                ...
                                                <div class="col-10 offset-1">
                                                    <div class="card card-info">
                                                        <div class="card-header border-0">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <h3 class="card-title"><img src="../profiles/<?php echo $image; ?>" alt="Capturista" class="img-circle img-fluid" style="width:35px; height:auto; border:1px solid #D2D3D4"> Base de datos Secretarías</h3>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- /.card-header -->
                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($secciones as $seccion) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a style="display: inline;" href="mod_secretaria.php?id=<?= $seccion[0]; ?>" title="Editar seccion" onclick="deshabilitar(this)" id="<?php if ($fila[22]  == 0) echo 'accion';
                                                                                                                                                                                                                        else echo ''; ?>"><i class="fas fa-edit fa-2x"></i></a>

                                                                                <a style="display: inline;" href="deleteSecretaria.php?id=<?= $seccion[0] ?>" title="Eliminar seccion" onclick="return ConfirmDelete()" id="<?php if ($fila[23]  == 0) echo 'accion';
