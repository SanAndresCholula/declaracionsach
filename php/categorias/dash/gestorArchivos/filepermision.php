...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active" style="color:#fff; font-size:medium"><i class="fa fa-lock"></i> Permisos </li>
        </ol>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="box box-primary">
                    ...
                    <form method="post" action="action/addfilepermision.php" role="form">
                        <!-- form start -->
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="name_folder">Enviar al área:</label>

                                <?php
                                $sql = "SELECT dependencia FROM usuarios WHERE dependencia <> 'categoria' ORDER BY dependencia desc";
                                $result = mysqli_query($con, $sql) or die(mysqli_error($con));;
                                ?>

                                <select name="dependencia" class="form-control select2" style="width: 100%" required>
                                    <option value="1">Selecciona destinatario</option>
                                    <?php
                                ...
                                <p class="text-muted text-right">Selecciona el área con quien compartir</p>
                            </div>
                        </div><!-- /.box-body -->
                            ...
                            <table class="table table-hover">
                                <tbody>
                                    ...
                                    <?php foreach ($permisions as $p) :
                                        ...
                                        $permission_id = $p['usuario'];
                                        $permi = mysqli_query($con, "select * from permision where usuario='$permission_id' ");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php if ($p['p_id'] == 1) {
                                                    echo "Ver, Descargar y Comentar";
                                                } ?></td>
                                            <td><span class="label label-success"><?php echo $p['created_at']; ?></span></td>
                                            <td style="width:30px;">
                                                <a href="action/delfilepermision.php?id=<?php echo $p['id']; ?>" class="btn btn-danger btn-xs"  onclick="return ConfirmDelete()"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
