    ...
    <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
        <section class="content-header"><!-- Content Header (Page header) -->
            ...
            <ol class="breadcrumb">
                ...
                <li class="active" style="color:#fff; font-size:medium">Nueva Carpeta</li>
            </ol>
        </section>
                        ...
                        <form role="form" action="action/addfolder.php" method="post"><!-- form start -->
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="filename" class="form-control" id="name_folder" placeholder="Nombre de la carpeta" required>
                                </div>
                                <div class="form-group">
                                    <label>Descripción</label>
                                    <textarea class="form-control" name="description" rows="3" style="max-width:100%; min-width:100%" placeholder="Descripción ..." required></textarea>
                                </div>
                                <div class="form-group">
