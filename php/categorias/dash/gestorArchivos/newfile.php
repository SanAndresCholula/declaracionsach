<?php 
    ...
    $folders = mysqli_query($con, "select * from file where usuario='$my_user_id' and is_folder=1 and folder_id is NULL order by created_at desc");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active" style="color:#fff; font-size:medium">Nuevo Archivo</li>
        </ol>
    </section>
                    ...
                    <form role="form" action="action/addfile.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="3" placeholder="E.j: Descripción de tu archivo..."></textarea>
                            </div>
                            <div class="form-group">
                                <label>Carpeta</label>
                            ...
                            <div class="form-group">
                                <span class="btn btn-my-button btn-file" style="width: 100%; margin-top: 5px;">
                                    Selecionar Archivo<input type="file" name="filename" required title="Selecciona algun archivo">
                                </span>
                            </div>
                            <div class="form-group">
                                <div class="checkbox icheck">
                                    <label>
                                        <input type="checkbox" name="is_public" required> &nbsp;Archivo Publico
                                    </label>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
