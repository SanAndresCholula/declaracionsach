...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1><i class="fa fa-globe"></i> Archivos Compartidos Conmigo

        </h1>
        <ol class="breadcrumb">
            <li><a href="home.php" style="color:#fff; font-size:medium"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active" style="color:#fff; font-size:medium">Compartidos conmigo</li>
        </ol>
    </section>
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                $files = "select * from permision where usuario='$user'";
                $resultado = mysqli_query($con, $files);
                ...
                <?php else : ?>
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <p class="alert alert-warning">
                            <i class="fa fa-exclamation-triangle"></i> No se encontraron archivos en la carpeta actual</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
