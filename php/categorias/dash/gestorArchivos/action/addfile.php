...
// agregar carpeta
	...
	if ($handle->uploaded) {
		$url="../storage/data/".$_SESSION["usuario"];
		$handle->Process($url);
		if($handle->processed){
	    $filename = $handle->file_dst_name;

		$sql = "INSERT INTO file (code, filename, description, is_public, usuario, is_folder, folder_id, created_at) VALUES ('$code','$filename','$description', $is_public, '$user_id', 0, $folder_id, NOW());";
