    ...
    <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
        <section class="content-header"><!-- Content Header (Page header) -->
            ...
            <ol class="breadcrumb">
                ...
                <li class="active" style="color:#fff; font-size:medium">Editar Archivo </li>
            </ol>
        </section>
                    ...
                    <div class="box box-primary"><!-- general form elements -->
                        ...
                        <form action="action/editfile.php" method="post" role="form"><!-- form start -->
                            ...
                            <div class="box-footer">
                                ...
                                <button type="button" class="btn btn-info"><a href="myfiles.php" style="color:white"><i class="fas fa-step-backward"> Regresar</i></a></button>
