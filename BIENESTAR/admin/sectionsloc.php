        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-white">CRUD Localidades</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                                ...
                                                <div class="col-6 offset-3">
                                                    <div class="card card-info">
                                                        <div class="card-header border-0">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <h3 class="card-title"><img src="../profiles/<?php echo $image; ?>" alt="Capturista" class="img-circle img-fluid" style="width:35px; height:auto; border:1px solid #D2D3D4"> Localidades</h3>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- /.card-header -->
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($row = $resultado->fetch_assoc()) { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a style="display: inline;" href="mod_localidad.php?id=<?php echo $row['id_loc']; ?>" title="Editar tipo de programa" onclick="deshabilitar(this)" id="<?php if ($fila[25]  == 0) echo 'accion';
                                                                                                                                                                                                                                        else echo ''; ?>"><i class="fas fa-edit fa-2x"></i></a>
                                                                                <a style="display: inline;" href="deleteLocalidad.php?id=<?php echo $row['id_loc']; ?>" title="Eliminar tipo de programa" onclick="return ConfirmDelete()" id="<?php if ($fila[26]  == 0) echo 'accion';
