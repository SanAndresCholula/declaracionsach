    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-white">CRUD Tipo de programas existentes</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                        ...
                        <div class="col-12">
                          <div class="card card-info">
                            <div class="card-header">
                              <div class="row">
                                <div class="col-12">
                                  <h3 class="card-title"><img src="../profiles/<?php echo $image; ?>" alt="Capturista" class="img-circle img-fluid" style="width:35px; height:auto; border:1px solid #D2D3D4"> Diferentes tipos de programas existentes</h3>
                                </div>
                              </div>
                            </div>
                            <!-- /.card-header -->
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <?php foreach ($rol as $fila) : ?>
                                          <a style="display: inline;" href="mod_tp.php?id=<?php echo $row['id_tp']; ?>" title="Editar tipo de programa" onclick="deshabilitar(this)" id="<?php if ($fila[22]  == 0) echo 'accion';
                                                                                                                                                                                          else echo ''; ?>"><i class="fas fa-edit fa-2x"></i></a>

                                          <a style="display: inline;" href="deleteTp.php?id=<?php echo $row['id_tp']; ?>" title="Eliminar tipo de programa" onclick="return ConfirmDelete()" id="<?php if ($fila[23]  == 0) echo 'accion';
