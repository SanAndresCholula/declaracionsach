...
<body class="hold-transition sidebar-mini layout-fixed hidden">
    ...
    <div class="wrapper">
                                                    ...
                                                    <div class="col-lg-12 col-md-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-sm-12">
                                                                ...
                                                                <button type="button" class="btn btn-danger"><a href="dash.php" style="color: #ffffff;" title="Salir al inicio"><i class="far fa-times-circle"></i> Salir</a></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <!-- Control Sidebar -->
        <aside class="control-sidebar control-sidebar-dark">P
