        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-white">CRUD Estatus Colores</h1>
                        </div>
                        <div class="col-sm-6">
                                                ...
                                                <div class="col-6 offset-3">
                                                    <div class="card card-info">
                                                        <div class="card-header border-0">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <h3 class="card-title"><img src="../profiles/<?php echo $image; ?>" alt="Capturista" class="img-circle img-fluid" style="width:35px; height:auto; border:1px solid #D2D3D4"> Base de datos estatus colores</h3>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                                    ...
                                                                    <?php foreach ($colors as $c) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <a style="display: inline;" href="mod_colors.php?id=<?= $c[0]; ?>" title="Editar seccion" onclick="deshabilitar(this)" id="<?php if ($fila[22]  == 0) echo 'accion';
                                                                                                                                                                                                            else echo ''; ?>"><i class="fas fa-edit fa-2x"></i></a>

                                                                                <a style="display: inline;" href="deleteColors.php?id=<?= $c[0] ?>" title="Eliminar seccion" onclick="return ConfirmDelete()" id="<?php if ($fila[23]  == 0) echo 'accion';
