                    ...
                    <div class="row justify-content-center">
                        <div class="col-6">
                            <div class="card">
                                ...
                                <form action="actualizarFormatos.php" method="POST" class="formulario">
                                    ...
                                    <div class="checkbox">
                                        <label style="font-size: 1.5rem">
                                            <input type="checkbox" name="categoria<?= $categoria[0] ?>" <?php if(tienePermisoFormatos($usuario, $categoria[0])) echo "checked" ?>>
                                            <?= $categoria[2] ?>
                                        </label>
                                    </div>
                                    <?php
