...
<head>
    ...
    <title>Agregar Formatos excel a usuario</title>
            ...
            <center>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-6">
                            <div class="card">
                                <p class="lead" id="text">Asignar el(los) formato(s) a <strong><big><u>
                                                <?= $usuario?></u></big></strong>
                                </p>

                                <form action="actualizarCoin.php" method="POST" class="formulario">
                                    ...
                                    <label for="text">Formatos excel en existencia, selecciona para agregar</label>
                                    <?php foreach( $categorias as $categoria ): ?>
                                    <div class="checkbox">
                                        <label style="font-size: 1.5rem">
                                            <input type="checkbox" name="categoria<?= $categoria[0] ?>" <?php if(tienePermisoCoin($usuario, $categoria[0])) echo "checked" ?>>
                                            <?= $categoria[2] ?>
                                        </label>
                                    </div>
                                    <?php
