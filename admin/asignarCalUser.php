...
<head>
    ...
    <title>Aignar Formatos Calendario a usuario</title>
...
<body class="text-center">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main role="main" class="inner cover">
            ...
            <p class="lead" id="text">Panel: Agregar formatos excel a usuarios</p>
            <hr class="style-one">
            ...
            <center>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-6">
                            <div class="card">
                                <p class="lead" id="text">Asignar el(los) formato(s) Calendarios a <strong><big><u>
                                                <?= $usuario?></u></big></strong>
                                </p>

                                <form action="actualizarCalendar.php" method="POST" class="formulario">
                                    ...
                                    <label for="text">Formatos Calendario de actividades, selecciona para agregar</label>
                                    <?php foreach( $categorias as $categoria ): ?>
                                    <div class="checkbox">
                                        <label style="font-size: 1.5rem">
                                            <input type="checkbox" name="categoria<?= $categoria[0] ?>" <?php if(tienePermisoCalendar($usuario, $categoria[0])) echo "checked" ?>>
                                            <?= $categoria[1] ?>
                                        </label>
                                    </div>
                                    <?php
