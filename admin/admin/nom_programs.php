    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">CRUD Nombre de programas </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                        ...
                        <div class="col-12">
                          <div class="card">
                            <div class="card-header">
                              <div class="row">
                                <div class="col-12">
                                  <h3 class="card-title">Nombres de programas</h3>
                                </div>
                              </div>
                            </div>
                            <!-- /.card-header -->
                                ...
                                <tbody>
                                  ...
                                  while ($row = $resultado->fetch_assoc()) { ?>
                                    <tr>
                                      ...
                                      <td>
                                        <a style="display: inline;" href="mod_np.php?id=<?php echo $row['id_np']; ?>" title="Editar nombre de programa" onclick="deshabilitar(this)" id="<?php if( $fila[22]  == 0) echo 'accion'; else echo ''; ?>"><i class="fas fa-edit fa-2x"></i></a>

                                        <a style="display: inline;" href="deleteNp.php?id=<?php echo $row['id_np']; ?>" title="Eliminar nombre de programa" onclick="return ConfirmDelete()" id="<?php if( $fila[23]  == 0) echo 'accion'; else echo ''; ?>"><i class="fas fa-trash-alt fa-2x"></i></a>
                                      </td>
                                    </tr>
                                  <?php } ?>
                                </tbody>
