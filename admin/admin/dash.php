        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10">
                            <h1 class="m-0 text-dark">Bienvenido: <b><?php echo $_SESSION['username'] ?></b></h1>
                        </div>
                        <div class="col-sm-2">
                ...
                <div class="container-fluid">
                    ...
                    <div class="<?php if ($fila[7] == 0 ) echo 'card collapsed-card';
                        ...
                        <div class="card-header border-0" style="background: #007bff; color:white">
                            ...
                            <!-- card tools -->
                            <div class="card-tools">
                            <?php if( $fila[7]  == 0 ) echo 'No tienes privilegio para ver esta tabla <i class="fas fa-ban"></i>'; else echo ' <button type="button" class="btn btn-primary btn-sm" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="card">
                                                                        <div class="card-header">
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                                                    <h3 class="card-title"><i class="fa fa-barcode" aria-hidden="true"></i> Scanner de códigos de barras</h3>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <div class="col-12 col-md-12">
                                                                                    ...
                                                                                    <center>
                                                                                        <marquee behavior="alternate" width=80% direction="right">
                                                                                            <font face=arial color=black size=5>&#9660;¡Escanea el codigo de la credencial aquí!&#9660;</font>
                                                                                        </marquee>
                                                                                    </center>
