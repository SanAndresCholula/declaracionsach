        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">CRUD secciones distritales</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                                ...
                                                <div class="col-6 offset-3">
                                                    <div class="card">
                                                        <div class="card-header border-0" style="background: #007bff; color:white">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <h3 class="card-title">Tabla Secciones</h3>
                                                                </div>
                                                            </div>
                                                        </div>                                              
                                                        <div class="card-body">
                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($secciones as $seccion) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a style="display: inline;" href="mod_seccion.php?id=<?= $seccion[0]; ?>" title="Editar seccion" onclick="deshabilitar(this)" id="<?php if( $fila[25]  == 0) echo 'accion'; else echo ''; ?>" ><i class="fas fa-edit fa-2x"></i></a>

                                                                                <a style="display: inline;" href="deleteSeccion.php?id=<?= $seccion[0] ?>" title="Eliminar seccion" onclick="return ConfirmDelete()" id="<?php if( $fila[26]  == 0) echo 'accion'; else echo ''; ?>" ><i class="fas fa-trash-alt fa-2x"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                    <?php endforeach ?>
                                                                </tbody>
