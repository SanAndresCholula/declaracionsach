        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-8">
                            <h1 class="text-black">CRUD Apoyos a todos los Beneficiarios</h1>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                <?php $count_benef = mysqli_query($conexion, "SELECT id_benef1 FROM events "); ?>
                                <div class="inner">
                                    <h3><?php echo mysqli_num_rows($count_benef); ?></h3>
                                    <p>Apoyos a Beneficiarios</p>
                                </div>
                                <div class="icon">
                                                        ...
                                                        <div class="card-header" style="background-color: #007bff;">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    <h3 class="card-title text-white">Apoyos registrados</h3>
                                                                </div>
                                                            </div>
                                                        </div>
