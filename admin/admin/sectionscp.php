        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">CRUD Código Postal</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                                ...
                                                <div class="col-6 offset-3">
                                                    <div class="card">
                                                        <div class="card-header border-0" style="background: #007bff; color:white">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <h3 class="card-title">Tabla Código Postal</h3>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <?php
                                                                    ...
                                                                    while ($row = $resultado->fetch_assoc()) { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <a style="display: inline;" href="mod_cp.php?id=<?php echo $row['id_cp']; ?>" title="Editar código postal" onclick="deshabilitar(this)" id="<?php if( $fila[25]  == 0) echo 'accion'; else echo ''; ?>" ><i class="fas fa-edit fa-2x"></i></a>

                                                                                <a style="display: inline;" href="deleteCP.php?id=<?php echo $row['id_cp']; ?>" title="Eliminar código postal" onclick="return ConfirmDelete()" id="<?php if( $fila[26]  == 0) echo 'accion'; else echo ''; ?>" ><i class="fas fa-trash-alt fa-2x"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                    <?php } ?>
                                                                </tbody>
