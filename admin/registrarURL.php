...
/* crear la consulta para insertar sql con una variable $insertar */
    $insertar = "INSERT INTO formatos( ruta, titulo,  clave, date) VALUES('$Vinculo','$Nombre','$Clave','$date')";

// validar usuarios y contraseñas que no se repitan... window.history.go(-1) retrocede una pagina anterior
   $verificar_Formato = mysqli_query($conexion, "SELECT * FROM formatos WHERE titulo = '$Nombre'");
